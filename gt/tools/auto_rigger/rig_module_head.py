...
class ModuleHead(ModuleGeneric):
    ...
    def __init__(self, name="Head", prefix=None, suffix=None):
        ...
        self.head_end.set_locator_scale(scale=1.5)
        ...
        self.jaw_end.set_locator_scale(scale=1.5)
        ...
        self.lt_eye.set_locator_scale(scale=1.5)
        ...
        self.rt_eye.set_locator_scale(scale=1.5)

...
TaskMapRename = batch_processor_tasks.TaskMapRename
TaskDeleteProjectFiles = batch_processor_tasks.TaskDeleteProjectFiles
TaskCompressZip = batch_processor_tasks.TaskCompressZip
...
InputTask = batch_processor_tasks.InputTask
MayaImportTask = batch_processor_tasks.MayaImportTask
RenameTask = batch_processor_tasks.RenameTask
MayaSaveTask = batch_processor_tasks.MayaSaveTask
UsdExportTask = batch_processor_tasks.UsdExportTask
FbxExportTask = batch_processor_tasks.FbxExportTask
RetargetTask = batch_processor_tasks.RetargetTask
HumanIKRetargetTask = batch_processor_tasks.HumanIKRetargetTask

...
class TestJointUtils(unittest.TestCase):
    ...
    def test_orient_joint(self):
        ...
        maya_test_tools.cmds.select(clear=True)
        joint_three = maya_test_tools.cmds.joint(name="three_jnt")
        maya_test_tools.cmds.setAttr(f'{joint_two}.tx', 3)
        maya_test_tools.cmds.setAttr(f'{joint_two}.tz', -3)
        maya_test_tools.cmds.setAttr(f'{joint_three}.tx', 6)
        maya_test_tools.cmds.setAttr(f'{joint_three}.tz', -6)
        ...
        one_x = maya_test_tools.cmds.getAttr(f'{joint_one}.jointOrientX')
        one_y = maya_test_tools.cmds.getAttr(f'{joint_one}.jointOrientY')
        one_z = maya_test_tools.cmds.getAttr(f'{joint_one}.jointOrientZ')
        ...
        for jnt in [joint_two, joint_three]:
            jnt_x = maya_test_tools.cmds.getAttr(f'{jnt}.jointOrientX')
            jnt_y = maya_test_tools.cmds.getAttr(f'{jnt}.jointOrientY')
            jnt_z = maya_test_tools.cmds.getAttr(f'{jnt}.jointOrientZ')
    ...
    def test_copy_parent_orients(self):
        ...
        maya_test_tools.cmds.setAttr(f'{joint_three}.tx', 6)
        maya_test_tools.cmds.setAttr(f'{joint_three}.tz', -6)
        maya_test_tools.cmds.setAttr(f'{joint_one}.jointOrientY', 33)
        maya_test_tools.cmds.parent(joint_two, joint_one)
        maya_test_tools.cmds.parent(joint_three, joint_two)
        ...
        self.assertAlmostEqualSigFig(0, one_z, tolerance=3)
        two_x = maya_test_tools.cmds.getAttr(f'{joint_two}.jointOrientX')
        two_y = maya_test_tools.cmds.getAttr(f'{joint_two}.jointOrientY')
        two_z = maya_test_tools.cmds.getAttr(f'{joint_two}.jointOrientZ')
        ...
        three_x = maya_test_tools.cmds.getAttr(f'{joint_three}.jointOrientX')
        three_y = maya_test_tools.cmds.getAttr(f'{joint_three}.jointOrientY')
        three_z = maya_test_tools.cmds.getAttr(f'{joint_three}.jointOrientZ')
    ...
    def test_reset_orients(self):
        ...
        maya_test_tools.cmds.setAttr(f'{joint_three}.tx', 6)
        maya_test_tools.cmds.setAttr(f'{joint_three}.tz', -6)
        maya_test_tools.cmds.setAttr(f'{joint_one}.jointOrientX', 33)
        maya_test_tools.cmds.setAttr(f'{joint_two}.jointOrientY', 33)
        maya_test_tools.cmds.setAttr(f'{joint_three}.jointOrientZ', 33)
        maya_test_tools.cmds.parent(joint_two, joint_one)
        maya_test_tools.cmds.parent(joint_three, joint_two)

...
class Icon:
    ...
    library_missing_file = get_icon_path(r"curve_library_missing_file.svg")
    ...
    library_build = get_icon_path(r"curve_library_build.svg")
    library_edit = get_icon_path(r"curve_library_edit.svg")
    library_snapshot = get_icon_path(r"curve_library_snapshot.svg")
    library_remove = get_icon_path(r"curve_library_remove.svg")
    library_add = get_icon_path(r"curve_library_add.svg")
    # User Interface

...
def launch_tool():
    ...
    """
    from tools.auto_rigger import rigger_biped_gui
...
def launch_biped_rig_interface():
    ...
    """
    from tools.auto_rigger import biped_rig_interface
...
def launch_retarget_assistant():
    ...
    """
    from tools.auto_rigger import rigger_retarget_assistant
...
def launch_game_exporter():
    ...
    """
    from tools.auto_rigger import rigger_game_exporter

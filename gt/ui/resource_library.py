...
class Icon:
    ...
    tool_script_library = get_icon_path(r"tool_script_library.svg")
    ...
    script_library_missing_icon = get_icon_path(r"script_library_missing_icon.svg")
    ...
    library_duplicate = get_icon_path(r"library_duplicate.svg")
    library_import = get_icon_path(r"library_import.svg")
    library_export = get_icon_path(r"library_export.svg")
    # Auto Rigger
    ...
    rigger_action_duplicate_grayscale = get_icon_path(r"rigger_action_duplicate_grayscale.svg")
    rigger_action_copy = get_icon_path(r"rigger_action_copy.svg")
    rigger_action_copy_grayscale = get_icon_path(r"rigger_action_copy_grayscale.svg")
    rigger_action_paste = get_icon_path(r"rigger_action_paste.svg")
    rigger_action_paste_grayscale = get_icon_path(r"rigger_action_paste_grayscale.svg")
    ...
    # Batch Processor
    batch_category_inputs = get_icon_path(r"batch_category_inputs.svg")
    batch_category_outputs = get_icon_path(r"batch_category_outputs.svg")
    batch_category_validation = get_icon_path(r"batch_category_validation.svg")
    batch_category_external = get_icon_path(r"batch_category_external.svg")
    batch_validator_pass = get_icon_path(r"batch_validator_pass.svg")
    batch_task_log_print = get_icon_path(r"batch_task_log_print.svg")
    ...
    ui_copy_text_bright = get_icon_path(r"ui_copy_text_bright.svg")

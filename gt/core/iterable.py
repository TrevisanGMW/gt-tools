...
def dict_as_formatted_str(input_dict, indent=1, width=80, depth=None, format_braces=True, one_key_per_line=False):
    """
...
def get_highest_int_from_str_list(str_list):
    ...
    """
    import gt.core.str as core_string

    digits_list = [core_string.extract_digits_as_int(item) for item in str_list]
    return max(digits_list, default=0)


def sanitize_maya_list(
    input_list,
    ...
    """
    from gt.core.naming import get_long_name, get_short_name

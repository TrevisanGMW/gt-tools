...
def build_gui_render_calculator():
    ...
    # Main GUI Start Here =================================================================================
    window_gui_render_calculator = cmds.window(
        window_name,
    ...
    cmds.rowColumnLayout(
        nc=3, cw=[(1, 10), (2, 325), (3, 50)], cs=[(1, 10), (2, 0), (3, 0)], p=content_main
    )  # Title Column
    ...
    time_per_frame = cmds.intSliderGrp(
        field=True,
        label="Average Time Per Frame: ",
        cw=[(1, 130), (2, 50), (3, 0)],
        minValue=1,
        maxValue=999999,
        fieldMinValue=1,
    ...
    icon = ui_qt.QtGui.QIcon(ui_res_lib.Icon.tool_render_calculator)

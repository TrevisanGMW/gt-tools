...
"""
from PySide2.QtWidgets import QPushButton, QLabel, QVBoxLayout, QFrame, QSpinBox, QHBoxLayout, QCheckBox
...
class RibbonToolView(metaclass=MayaWindowMeta):
    ...
    def create_layout(self):
        ...
        mid_layout.addWidget(self.equidistant_label)
        mid_layout.addWidget(self.equidistant_checkbox)
        mid_layout.setContentsMargins(15, 15, 15, 15)  # L-T-R-B

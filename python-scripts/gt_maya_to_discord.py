...
def discord_post_attachment(username, message, file_path, webhook_url):
    ...
    #username = 'abc'
    #message = 'abc'
    #file_path = 'C:\\Users\\TrevisanGMW\\Desktop\\old\\abc.jpg'
    #webhook_url = 'https://discord.com/api/webhooks/843586759425523714/RB5ILSBzvgnLkFvEOAEx_NK2EQYbgVerZhA0VWysZ_Ydml6vZ9TD1PBhi3YT7Tfp1Dlq'
    if python_version == 3:

...
class TestAttributeUtils(unittest.TestCase):
    ...
    def test_hide_lock_default_attributes_with_visibility(self):
        cube = maya_test_tools.create_poly_cube()
        attr_utils.hide_lock_default_attrs(cube, translate=True, rotate=True, scale=True, visibility=True)
    ...
    def test_hide_lock_default_attributes_without_visibility(self):
        cube = maya_test_tools.create_poly_cube()
        attr_utils.hide_lock_default_attrs(cube, translate=True, rotate=True, scale=True, visibility=False)
    ...
    def test_hide_lock_default_attributes_no_translate(self):
        cube = maya_test_tools.create_poly_cube()
        attr_utils.hide_lock_default_attrs(cube, translate=False, rotate=True, scale=True, visibility=False)
    ...
    def test_hide_lock_default_attributes_no_rotate(self):
        cube = maya_test_tools.create_poly_cube()
        attr_utils.hide_lock_default_attrs(cube, translate=True, rotate=False, scale=True, visibility=False)
    ...
    def test_hide_lock_default_attributes_no_scale(self):
        cube = maya_test_tools.create_poly_cube()
        attr_utils.hide_lock_default_attrs(cube, translate=True, rotate=True, scale=False, visibility=False)

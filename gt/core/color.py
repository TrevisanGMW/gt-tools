...
class ColorConstants:
    ...
    class RigOutliner:
        ...
        GRP_ROOT_RIG = (1, 0.45, 0.7)  # Salmon
        GRP_ROOT_PROXY = (1, 0.75, 0.85)  # Soft Salmon
        GRP_GEOMETRY = (0.3, 1, 0.8)  # Bright Turquoise
        GRP_SKELETON = (0.75, 0.45, 0.95)  # Purple
        GRP_CONTROL = (1, 0.45, 0.2)  # Orange
        GRP_SETUP = (1, 0.25, 0.25)  # Soft Red
        CTRL = (1, 0.65, 0.45)  # Soft Orange
        AUTOMATION = (1, 0.65, 0.45)  # Soft Orange
        FK = (1, 0.5, 0.5)  # Soft Red
        IK = (0.5, 0.5, 1)  # Soft Blue
        DATA_QUERY = (1, 1, 1)  # White
...
def add_side_color_setup(
    obj,
    color_attr_name="autoColor",
    ...
    obj_name = core_naming.get_short_name(obj)
    ...
    core_attr.add_attr_double_three(obj, clr_attr, keyable=False)
    ...
    core_attr.add_attr_double_three(obj, r_clr_attr, keyable=False)
    ...
    core_attr.add_attr_double_three(obj, l_clr_attr, keyable=False)
...
def get_directional_color(
    ...
    tolerance=0.001,
):  # Add the new tolerance argument with a default value
    """

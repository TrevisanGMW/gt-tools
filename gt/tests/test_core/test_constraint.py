...
class TestConstraintCore(unittest.TestCase):
    def setUp(self):
    ...
    def test_get_constraint_function_parent(self):
        ...
        function = core_constraint.get_constraint_function(constraint_type=constraint_type)
    ...
    def test_get_constraint_function_orient(self):
        ...
        constraint_type = core_constraint.ConstraintTypes.ORIENT
        function = core_constraint.get_constraint_function(constraint_type=constraint_type)
        self.assertEqual(expected, function)
    ...
    def test_get_constraint_function_scale(self):
        ...
        constraint_type = core_constraint.ConstraintTypes.SCALE
        function = core_constraint.get_constraint_function(constraint_type=constraint_type)
        self.assertEqual(expected, function)
    ...
    def test_get_constraint_function_aim(self):
        ...
        constraint_type = core_constraint.ConstraintTypes.AIM
        function = core_constraint.get_constraint_function(constraint_type=constraint_type)
        self.assertEqual(expected, function)
    ...
    def test_get_constraint_function_other(self):
        ...
        constraint_type = core_constraint.ConstraintTypes.GEOMETRY
        function = core_constraint.get_constraint_function(constraint_type=constraint_type)
        self.assertEqual(expected, function)
        expected = cmds.normalConstraint
        constraint_type = core_constraint.ConstraintTypes.NORMAL
        function = core_constraint.get_constraint_function(constraint_type=constraint_type)
        self.assertEqual(expected, function)
        expected = cmds.tangentConstraint
        constraint_type = core_constraint.ConstraintTypes.TANGENT
        function = core_constraint.get_constraint_function(constraint_type=constraint_type)
        self.assertEqual(expected, function)
        expected = cmds.poleVectorConstraint
        constraint_type = core_constraint.ConstraintTypes.POLE_VECTOR
        function = core_constraint.get_constraint_function(constraint_type=constraint_type)
        self.assertEqual(expected, function)

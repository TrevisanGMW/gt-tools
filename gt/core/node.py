...
from gt.core.uuid import get_uuid, get_object_from_uuid
...
class Node:
    ...
    def __eq__(self, other):
        ...
        Raises:
           TypeError: If the 'other' operand is not a Node, str instance or None.
        """
        if other is None:
            return False
        if isinstance(other, (Node, str)):
            ...
            raise TypeError(f'Unsupported operand type for "Node" and "{type(other).__name__}"')
